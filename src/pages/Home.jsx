...
const Home = () => {
  return (
    <div className="ml-[59px] flex flex-col md:flex-row lg:gap-[10rem] md:gap-8">
      <iframe
        ...
        className="rounded-[100%] lg:rounded-lg md:rounded-lg mt-[45px] lg:w-[700px] md:w-[500px]  w-[300px] mx-auto md:mx-0"
      ></iframe>
